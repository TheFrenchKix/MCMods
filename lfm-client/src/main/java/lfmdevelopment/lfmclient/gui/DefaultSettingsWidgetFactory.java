...
import lfmdevelopment.lfmclient.gui.screens.settings.*;
import lfmdevelopment.lfmclient.gui.themes.lfm.widgets.WlfmLabel;
...
public class DefaultSettingsWidgetFactory extends SettingsWidgetFactory {
    ...
    private static class WSelectedCountLabel extends WlfmLabel {
