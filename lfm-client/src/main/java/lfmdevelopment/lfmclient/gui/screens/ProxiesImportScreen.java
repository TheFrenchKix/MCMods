...
package lfmdevelopment.lfmclient.gui.screens;
...
import lfmdevelopment.lfmclient.systems.proxies.ProxyType;
    ...
    public void initWidgets() {
        if (file.exists() && file.isFile()) {
            ...
            try {
                ...
                lfmClient.LOG.error("An error occurred while importing the proxy file", e);
            }
        } else {
