...
import lfmdevelopment.lfmclient.gui.renderer.operations.TextOperation;
import lfmdevelopment.lfmclient.gui.renderer.packer.GuiTexture;
import lfmdevelopment.lfmclient.gui.renderer.packer.TexturePacker;
import lfmdevelopment.lfmclient.gui.widgets.WWidget;
import lfmdevelopment.lfmclient.renderer.Renderer2D;
...
import static lfmdevelopment.lfmclient.utils.Utils.getWindowHeight;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(lfmClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(lfmClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(lfmClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(lfmClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(lfmClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(lfmClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(lfmClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(lfmClient.identifier("textures/icons/gui/paste.png"));
