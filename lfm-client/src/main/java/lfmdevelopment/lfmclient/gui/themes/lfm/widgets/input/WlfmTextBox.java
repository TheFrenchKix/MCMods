...
package lfmdevelopment.lfmclient.gui.themes.lfm.widgets.input;
...
import lfmdevelopment.lfmclient.gui.widgets.containers.WVerticalList;
...
public class WlfmTextBox extends WTextBox implements lfmWidget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WlfmTextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WlfmLabel implements ICompletionItem {
