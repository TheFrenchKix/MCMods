...
import lfmdevelopment.lfmclient.gui.renderer.packer.TextureRegion;
...
public class Renderer2D {
    ...
    public Renderer2D(boolean textured) {
        ...
        triangles = new MeshBuilder(textured ? lfmRenderPipelines.UI_TEXTURED : lfmRenderPipelines.UI_COLORED);
        lines = new MeshBuilder(lfmRenderPipelines.UI_COLORED_LINES);
    }
    ...
    public void render(String samplerName, GpuTextureView samplerView, GpuSampler sampler) {
        ...
        MeshRenderer.begin()
            ...
            .pipeline(lfmRenderPipelines.UI_COLORED_LINES)
            .mesh(lines)
            .end();

        MeshRenderer.begin()
            .attachments(MinecraftClient.getInstance().getFramebuffer())
            .pipeline(textured ? lfmRenderPipelines.UI_TEXTURED : lfmRenderPipelines.UI_COLORED)
            .mesh(triangles)
