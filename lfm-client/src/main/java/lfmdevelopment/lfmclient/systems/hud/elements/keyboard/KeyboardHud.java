...
package lfmdevelopment.lfmclient.systems.hud.elements.keyboard;
...
import lfmdevelopment.lfmclient.mixin.KeyBindingAccessor;
...
import lfmdevelopment.lfmclient.systems.hud.HudRenderer;
...
public class KeyboardHud extends HudElement {
    ...
    public KeyboardHud() {
        ...
        lfmClient.EVENT_BUS.subscribe(this);
    }
    ...
    public void render(HudRenderer renderer) {
        ...
        // because of a lfm bug, the modules search field swallows inputs
        InputUtil.Key guiKey = ((KeyBindingAccessor) KeyBinds.OPEN_GUI).lfm$getKey();
    ...
    public static class Key {
        ...
        public boolean matches(int input, int scancode, boolean key) {
            if (keybind != null) {
                ...
                InputUtil.Key inputKey = ((KeyBindingAccessor) binding).lfm$getKey();
        ...
        public boolean isNativelyPressed() {
            ...
            if (keybind != null) {
                ...
                int key = ((KeyBindingAccessor) binding).lfm$getKey().getCode();
                return key >= 0 && key < 8
