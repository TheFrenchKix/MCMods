...
import lfmdevelopment.lfmclient.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(lfmRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(lfmRenderPipelines.UI_TEXT);
