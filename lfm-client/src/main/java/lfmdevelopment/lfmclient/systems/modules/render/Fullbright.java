...
import lfmdevelopment.lfmclient.mixin.StatusEffectInstanceAccessor;
...
public class Fullbright extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (mc.player.hasStatusEffect(Registries.STATUS_EFFECT.getEntry(StatusEffects.NIGHT_VISION.value()))) {
            ...
            if (instance != null && instance.getDuration() < 420) ((StatusEffectInstanceAccessor) instance).lfm$setDuration(420);
        } else {
