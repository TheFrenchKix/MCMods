...
package lfmdevelopment.lfmclient.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> titleScreenCredits = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show lfm credits on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> titleScreenSplashes = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show lfm splash texts on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<String> customWindowTitleText = sgVisual.add(new StringSetting.Builder()
        ...
        .defaultValue("Minecraft {mc_version} - {lfm.name} {lfm.version}")
        .onChanged(value -> mc.updateWindowTitle())
        .build()
    );
    ...
    public final Setting<Boolean> chatFeedback = sgChat.add(new BoolSetting.Builder()
        .name("chat-feedback")
        .description("Sends chat feedback when lfm performs certain actions.")
        .defaultValue(true)
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", lfmClient.VERSION.toString());
