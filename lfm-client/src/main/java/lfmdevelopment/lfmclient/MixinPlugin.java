...
import lfmdevelopment.lfmclient.asm.Asm;
...
public class MixinPlugin implements IMixinConfigPlugin {
    private static final String mixinPackage = "lfmdevelopment.lfmclient.mixin";
    ...
    public void onLoad(String mixinPackage) {
        ...
        try {
            ...
            lfmClient.LOG.error("Error loading the mixin plugin", e);
        }
