...
import lfmdevelopment.lfmclient.utils.misc.text.TextUtils;
...
import static lfmdevelopment.lfmclient.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        ((IVec3d) horizontalVelocity).lfm$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).lfm$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(), mc.player.getZ());
        ((IVec3d) vec2).lfm$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3d) vec2).lfm$set(entity.getX(), entity.getY() + entity.getStandingEyeHeight(), entity.getZ());
