...
public class Capes {
    private static final String CAPE_OWNERS_URL = "https://lfmclient.com/api/capeowners";
    private static final String CAPES_URL = "https://lfmclient.com/api/capes";
    ...
    @PreInit(dependencies = lfmExecutor.class)
    public static void init() {
        ...
        lfmExecutor.execute(() -> {
            ...
            Stream<String> lines = Http.get(CAPE_OWNERS_URL)
                .exceptionHandler(e -> lfmClient.LOG.error("Could not load capes: {}",  e.getMessage()))
                .sendLines();
            if (lines != null) {
                lines.forEach(s -> {
        ...
        lfmClient.EVENT_BUS.subscribe(Capes.class);
    }
    ...
    private static class Cape {
        ...
        public Cape(String name) {
            this.identifier = lfmClient.identifier("capes/" + COUNT++);
            this.name = name;
        }
        ...
        public void download() {
            ...
            lfmExecutor.execute(() -> {
                try {
                    ...
                    lfmClient.LOG.error("Failed to download cape '{}'", name, e);
                }
            });
        }
