...
public class PacketUtilsUtil {
    ...
    public static void init() throws IOException {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
            writer.write("/*\n");
            writer.write(" * This file is part of the lfm Client distribution (https://github.com/lfmDevelopment/lfm-client/).\n");
            writer.write(" * Copyright (c) lfm Development.\n");
            writer.write(" */\n\n");

            writer.write("package lfmdevelopment.lfmclient.utils.network;\n\n");
