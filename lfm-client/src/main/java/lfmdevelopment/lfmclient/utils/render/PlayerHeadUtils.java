...
import lfmdevelopment.lfmclient.systems.accounts.TexturesJson;
import lfmdevelopment.lfmclient.systems.accounts.UuidToProfileResponse;
...
public class PlayerHeadUtils {
    ...
    public static String getSkinUrl(UUID id) {
        UuidToProfileResponse res2 = Http.get("https://sessionserver.mojang.com/session/minecraft/profile/" + id)
            .exceptionHandler(e -> lfmClient.LOG.error("Could not contact mojang session servers.", e))
