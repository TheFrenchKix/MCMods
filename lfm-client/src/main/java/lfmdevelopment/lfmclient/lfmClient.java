...
package lfmdevelopment.lfmclient;
...
import lfmdevelopment.lfmclient.systems.modules.misc.DiscordPresence;
import lfmdevelopment.lfmclient.utils.PostInit;
import lfmdevelopment.lfmclient.utils.PreInit;
import lfmdevelopment.lfmclient.utils.ReflectInit;
import lfmdevelopment.lfmclient.utils.Utils;
import lfmdevelopment.lfmclient.utils.misc.Version;
import lfmdevelopment.lfmclient.utils.misc.input.KeyAction;
import lfmdevelopment.lfmclient.utils.misc.input.KeyBinds;
...
public class lfmClient implements ClientModInitializer {
    public static final String MOD_ID = "lfm-client";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static lfmClient INSTANCE;
    public static lfmAddon ADDON;
    ...
    static {
        ...
        BUILD_NUMBER = MOD_META.getCustomValue(lfmClient.MOD_ID + ":build_number").getAsString();
    }
    ...
    public void onInitializeClient() {
        ...
        // Initialise addons
        AddonManager.ADDONS.forEach(lfmAddon::onInitialize);
