...
public class MeshRenderer {
    ...
    public void end() {
        ...
        // todo hope this is alright @lfm take a look please (lossy conversion from long to int)
        ...
        if (indexCount > 0) {
...

            {
                ...
                RenderPass pass = (depthAttachment != null && pipeline.wantsDepthTexture()) ?
                    RenderSystem.getDevice().createCommandEncoder().createRenderPass(() -> "lfm MeshRenderer", colorAttachment, clearColor, depthAttachment, OptionalDouble.empty()) :
                    RenderSystem.getDevice().createCommandEncoder().createRenderPass(() -> "lfm MeshRenderer", colorAttachment, clearColor);
