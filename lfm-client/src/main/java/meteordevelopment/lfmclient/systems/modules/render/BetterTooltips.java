...
import lfmdevelopment.lfmclient.events.render.TooltipDataEvent;
import lfmdevelopment.lfmclient.gui.screens.ContainerInventoryScreen;
import lfmdevelopment.lfmclient.mixin.EntityAccessor;
import lfmdevelopment.lfmclient.mixin.EntityBucketItemAccessor;
...
import lfmdevelopment.lfmclient.utils.misc.ByteCountDataOutput;
...
import lfmdevelopment.lfmclient.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    ...
    private void getTooltipData(TooltipDataEvent event) {
        ...
        // Fish peek
            ...
            EntityType<?> type = ((EntityBucketItemAccessor) bucketItem).lfm$getEntityType();
            ...
            if (entity != null) {
                ...
                ((EntityAccessor) entity).lfm$setInWater(true);
