...
import lfmdevelopment.lfmclient.events.entity.player.StartBreakingBlockEvent;
...
public class AutoTool extends Module {
    ...
    private static boolean isFortunable(Block block) {
        ...
        return block.getDefaultState().isIn(BlockTags.COAL_ORES) || block.getDefaultState().isIn(BlockTags.IRON_ORES) ||
            block.getDefaultState().isIn(BlockTags.COPPER_ORES) || block.getDefaultState().isIn(BlockTags.GOLD_ORES) ||
            block.getDefaultState().isIn(BlockTags.REDSTONE_ORES) || block.getDefaultState().isIn(BlockTags.LAPIS_ORES) ||
            block.getDefaultState().isIn(BlockTags.DIAMOND_ORES) || block.getDefaultState().isIn(BlockTags.EMERALD_ORES) ||
