...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = lfmClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = lfmClient.identifier("textures/container-transparent.png");
