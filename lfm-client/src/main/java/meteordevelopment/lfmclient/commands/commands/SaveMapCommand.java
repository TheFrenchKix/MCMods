...
import lfmdevelopment.lfmclient.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapTexture texture = textureManager.lfm$invokeGetMapTexture(map.get(DataComponentTypes.MAP_ID), state);
        ...
        try {
            ...
            lfmClient.LOG.error(e.toString());
        }
    }
