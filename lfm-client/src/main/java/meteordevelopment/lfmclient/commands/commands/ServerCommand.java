    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof CommandTreeS2CPacket packet) {
            ...
            packet.getCommandTree(
                CommandRegistryAccess.of(handler.lfm$getCombinedDynamicRegistries(), handler.lfm$getEnabledFeatures()),
                ClientPlayNetworkHandlerAccessor.lfm$getCommandNodeFactory()
