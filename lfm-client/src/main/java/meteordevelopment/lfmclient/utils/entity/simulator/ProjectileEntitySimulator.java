...
package lfmdevelopment.lfmclient.utils.entity.simulator;

import lfmdevelopment.lfmclient.mixin.CrossbowItemAccessor;
import lfmdevelopment.lfmclient.mixin.ProjectileInGroundAccessor;
...
public class ProjectileEntitySimulator {
    ...
    public boolean set(Entity user, ItemStack itemStack, double angleOffset, boolean accurate, float tickDelta) {
        ...
        switch (item) {
            ...
            case CrossbowItem ignored -> {
                ...
                float speed = CrossbowItemAccessor.lfm$getSpeed(projectilesComponent);
    ...
    public boolean set(Entity entity) {
        ...
        if (entity instanceof ProjectileInGroundAccessor ppe && ppe.lfm$invokeIsInGround()) return false;
    ...
    private SimulationStep getCollision() {
        ...
        if (blockCollision.getType() != HitResult.Type.MISS) {
            ((IVec3d) pos3d).lfm$set(blockCollision.getPos());
        }
