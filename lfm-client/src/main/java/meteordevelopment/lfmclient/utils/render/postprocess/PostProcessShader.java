...
public abstract class PostProcessShader {
    ...
    protected PostProcessShader(RenderPipeline pipeline) {
        ...
        this.framebuffer = new SimpleFramebuffer(lfmClient.NAME + " PostProcessShader " + this.getClass().getSimpleName(), mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight(), true);
    }
    ...
    private static final DynamicUniformStorage<UniformData> UNIFORM_STORAGE = new DynamicUniformStorage<>("lfm - Post UBO", UNIFORM_SIZE, 16);
