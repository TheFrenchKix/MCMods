...
import lfmdevelopment.lfmclient.mixininterface.IRaycastContext;
...
public abstract class RaycastContextMixin implements IRaycastContext {
    ...
    @Override
    public void lfm$set(Vec3d start, Vec3d end, RaycastContext.ShapeType shapeType, RaycastContext.FluidHandling fluidHandling, Entity entity) {
        this.start = start;
        this.end = end;
