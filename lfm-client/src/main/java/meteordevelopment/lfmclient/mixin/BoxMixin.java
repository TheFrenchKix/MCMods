...
import lfmdevelopment.lfmclient.mixininterface.IBox;
...
public abstract class BoxMixin implements IBox {
    ...
    @Override
    public void lfm$expand(double v) {
        this.minX -= v;
        this.minY -= v;
        this.minZ -= v;
        this.maxX += v;
    ...
    @Override
    public void lfm$set(double x1, double y1, double z1, double x2, double y2, double z2) {
