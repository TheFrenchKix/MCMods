...
package lfmdevelopment.lfmclient.mixin.lithium;

import com.llamalad7.mixinextras.injector.ModifyExpressionValue;
import com.llamalad7.mixinextras.sugar.Local;
import lfmdevelopment.lfmclient.lfmClient;
import lfmdevelopment.lfmclient.events.world.CollisionShapeEvent;
...
public abstract class ChunkAwareBlockCollisionSweeperMixin extends ChunkAwareBlockCollisionSweeper<VoxelShape> {
    ...
    private VoxelShape modifyCollisionShape(VoxelShape original, @Local(name = "state") BlockState state) {
        ...
        CollisionShapeEvent event = lfmClient.EVENT_BUS.post(CollisionShapeEvent.get(state, pos, original));
