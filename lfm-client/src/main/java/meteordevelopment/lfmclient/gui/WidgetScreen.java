...
import lfmdevelopment.lfmclient.gui.renderer.GuiDebugRenderer;
...
import lfmdevelopment.lfmclient.gui.widgets.WRoot;
...
import lfmdevelopment.lfmclient.utils.misc.CursorStyle;
...
public abstract class WidgetScreen extends Screen {
    ...
    public void removed() {
        if (!closed || lockedAllowClose) {
            ...
            lfmClient.EVENT_BUS.unsubscribe(this);
            GuiKeyEvents.canUseKeys = true;
