...
public class SmoothAim {
     ...
     */
    private static final float BASE_LERP = 0.035f;
     ...
     */
    private static final float LERP_VARIATION = 0.012f;
     ...
     */
    private static final float FAST_ZONE_DEG = 55f;

    /** Speed multiplier at the bottom of the slow zone (0 degrees total delta). */
    private static final float SPEED_AT_ZERO    = 0.35f;
    /** Speed multiplier at the top of the slow zone / bottom of fast zone. */
    private static final float SPEED_AT_SLOW    = 1.0f;
    /** Speed multiplier above the fast zone. */
    private static final float SPEED_AT_FAST    = 1.25f;
     ...
     */
    private static final float MAX_YAW_STEP   = 4.5f;
    ...
    /**
     * Convenience overload — aims at the entity's eye position.
     ...
     */
    private static float linearSpeedScale(float totalDelta) {
        if (totalDelta <= 0f) {
