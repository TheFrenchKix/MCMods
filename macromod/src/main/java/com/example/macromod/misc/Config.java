...
import com.example.macromod.pathfinding.path.PathRenderable;
...
public class Config {
    ...
    public static void setPathfindingTimeout(float timeoutSeconds) {
        ...
        StevebotLog.log("Set pathfindingTimeoutSeconds: " + getPathfindingTimeout());
    }
    ...
    public static void setPathStyle(PathRenderable.PathStyle pathStyle) {
        ...
        StevebotLog.log("Set pathStyle: " + getPathStyle());
    }
    ...
    public static void setVerboseMode(boolean verboseMode) {
        ...
        StevebotLog.log("Enable verboseMode: " + isVerboseMode());
    }
    ...
    public static void setShowChunkCache(boolean showChunkCache) {
        ...
        StevebotLog.log("Show chunkCache: " + isShowChunkCache());
    }
    ...
    public static void setShowNodeCache(boolean showNodeCache) {
        ...
        StevebotLog.log("Show nodeCache: " + isShowNodeCache());
    }
    ...
    public static void setPathfindingSlowdown(int pathfindingSlowdown) {
        ...
        StevebotLog.log("Set pathfinding-slodown: " + getPathfindingSlowdown() + "ms");
    }
    ...
    public static void setKeepPathRenderable(boolean keepPathRenderable) {
        ...
        StevebotLog.log("Set keepPathRenderable: " + isKeepPathRenderable());
    }
